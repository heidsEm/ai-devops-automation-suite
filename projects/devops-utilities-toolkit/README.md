...
- Fast XML policy inspection
- Traffic analytics visualization generator
...
## Setup
1. Run `python src/cert-converter/cer_to_pem.py cert.cer cert.pem`.
